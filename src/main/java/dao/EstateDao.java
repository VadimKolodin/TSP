...
public class EstateDao extends AbstractDao<RealEstate, Integer>{
    ...
    @Override
    public boolean update(RealEstate estate) throws SQLException {
    ...
    public boolean updateEstateStatus(EstateStatus status) throws SQLException {
    ...
    public EstateStatus getEstateStatusById(Integer eid) throws SQLException{
        ...
        if (resultSet.next()){
            estateStatus = new EstateStatus(
                    ...
                    resultSet.getDate("SOLD_D").toLocalDate()
            );
        }
        pr.close();
        return estateStatus;
    ...
    @Override
    public boolean create(RealEstate estate) throws SQLException {
    ...
    public boolean createEstateStatus(EstateStatus status) throws SQLException {
